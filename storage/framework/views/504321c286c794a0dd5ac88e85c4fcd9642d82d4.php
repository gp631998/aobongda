...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li data-toggle="collapse" data-target="#listproduct" class="collapsed">
            <a style="color: white" href="<?php echo e(route('danh-sach-san-pham')); ?>"><i class="fa fa-globe fa-lg"></i> List Product <span class="arrow"></span></a>
        </li>
        <li data-toggle="collapse" data-target="#listcategory" class="collapsed">
            <a style="color: white" href="<?php echo e(route('list-danh-muc')); ?>"><i class="fa fa-globe fa-lg"></i> List Category <span class="arrow"></span></a>
        </li>
        <li style="color: white" data-toggle="collapse" data-target="#listcategory" class="collapsed">
            <a style="color: white" href="<?php echo e(route('list-don-hang')); ?>"><i class="fa fa-globe fa-lg"></i> List Order <span class="arrow"></span></a>
        </li>
